...
import { 
  ...
  Video, MessageSquare, TrendingUp, Palette, ArrowRight, Shield
} from 'lucide-react';
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link to={createPageUrl('Onboarding')}>
                <Button size="lg" className="bg-gradient-to-r from-teal-500 to-purple-500 hover:from-teal-600 hover:to-purple-600 text-lg px-8 py-6">
            ...
            <Card className="h-full bg-gradient-to-br from-amber-900/30 to-orange-900/30 border-amber-500/50 relative overflow-hidden">
              ...
              <CardContent className="p-8 pt-12">
                ...
                <Link to={createPageUrl('Onboarding')} className="block">
                  <Button className="w-full bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-lg py-6">
      ...
      <div className="bg-gradient-to-r from-teal-900/50 via-purple-900/50 to-pink-900/50 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            <Link to={createPageUrl('Onboarding')}>
              <Button size="lg" className="bg-gradient-to-r from-teal-500 via-purple-500 to-pink-500 hover:from-teal-600 hover:via-purple-600 hover:to-pink-600 text-lg px-12 py-6">
