...
export default function Settings() {
  ...
  const [formData, setFormData] = useState({
    ...
    enabled_modules: ['tiktok', 'gifter', 'goals', 'tasks', 'work', 'cleaning', 'motivations', 'quick_notes', 'prayer', 'wellness', 'supplements', 'medications', 'pets', 'care_reminders', 'people', 'journal', 'mental_health'],
    feature_order: [],
  ...
  useEffect(() => {
    if (preferences) {
      ...
      custom_motivation_topics: preferences.custom_motivation_topics || [],
        ...
        enabled_modules: preferences.enabled_modules || ['tiktok', 'gifter', 'goals', 'tasks', 'work', 'cleaning', 'motivations', 'quick_notes', 'prayer', 'wellness', 'supplements', 'medications', 'pets', 'care_reminders', 'people', 'journal', 'mental_health'],
